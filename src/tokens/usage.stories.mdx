<Meta title="Tokens|Usage"></Meta>

# Get started

Collabur Design System Design System is a reusable component library that helps contributors build UIs faster. The goal is to make building durable UIs more productive and satisfying.
...
Collabur Design System components are written in Stencil.
...
```tsx
import { applyPolyfills, defineCustomElements } from '@collabur/cds/dist/loader';
...
applyPolyfills().then(() => {
  defineCustomElements(window)
})
...
import { defineCustomElements } from '@collabur/cds/dist/loader/index.cjs';

Vue.config.productionTip = false;
Vue.config.ignoredElements = [/cds-\w*/];
